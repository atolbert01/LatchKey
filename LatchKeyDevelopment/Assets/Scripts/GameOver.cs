...
public class GameOver : MonoBehaviour {
    ...
    void displayText()
    {
        ...
        GUI.Label(new Rect((Screen.width - width) / 2, 120, width, height), "Player 1 score: " + playerScore, guiStyle);
        if (highScorer())
        {
            GUI.Label(new Rect((Screen.width - width) / 2, 200, width, height), "NEW HIGH SCORER!!", guiStyle);
            ...
            GUI.Label(new Rect((Screen.width - width) / 2, 200, width, height), "Sorry, you stink", guiStyle);
